...
public class AdmobAdapterCalculatorTest {
    ...
    @Test
    public void testGetAdsCountToPublish_fetchedCntIs3_Result3() {
        assertThat(testGetAdsCountToPublishHelper(10, 0, 10, 3, 100), is(3));
    }

    @Test
    public void testGetAdsCountToPublish_fetchedCntIs0_Result0() {
        assertThat(testGetAdsCountToPublishHelper(10, 0, 10, 0, 100), is(0));
    }

    @Test
    public void testGetAdsCountToPublish_sourceItemsCntIs1_Result1() {
        assertThat(testGetAdsCountToPublishHelper(10, 0, 10, 3, 1), is(1));
    }

    @Test
    public void testGetAdsCountToPublish_sourceItemsCntIs0_Result0() {
        assertThat(testGetAdsCountToPublishHelper(10, 0, 10, 10, 0), is(0));
    }

    @Test
    public void testGetAdsCountToPublish_firstIdxIs99_Result1() {
        assertThat(testGetAdsCountToPublishHelper(10, 99, 10, 10, 100), is(1));
    }

    @Test
    public void testGetAdsCountToPublish_firstIdxIs10_Result10() {
        assertThat(testGetAdsCountToPublishHelper(10, 10, 10, 10, 100), is(10));
    }

    @Test
    public void testGetAdsCountToPublish_firstIdxIs11_Result9() {
        assertThat(testGetAdsCountToPublishHelper(10, 11, 10, 10, 100), is(9));
    }

    @Test
    public void testGetAdsCountToPublish_firstIdxIs0_Result10() {
        assertThat(testGetAdsCountToPublishHelper(10, 0, 10, 10, 100), is(10));
    }

    @Test
    public void testGetAdsCountToPublish_itemsBetweenAds1_Result100() {
        assertThat(testGetAdsCountToPublishHelper(1, 0, 200, 200, 100), is(101));
    }

    @Test
    public void testGetAdsCountToPublish_itemsBetweenAds0_Result0() {
        assertThat(testGetAdsCountToPublishHelper(0, 0, 200, 200, 100), is(0));
    }

    @Test
    public void testGetAdsCountToPublish_limitAdsIs0_Result0() {
        assertThat(testGetAdsCountToPublishHelper(10, 0, 0, 10, 100), is(0));
    }

    @Test
    public void testGetAdsCountToPublish_limitAdsIs10_Result10() {
    ...
    @Test
    public void testGetAdIndex_position100_firstIdxIs99_Result0() {
        setupAdmobAdapterCalculatorHelper(10, 99, 10);
        assertThat(admobAdapterCalculator.getAdIndex(100), is(0));
    }

    @Test
    public void testGetAdIndex_position10_firstIdxIs10_Result0() {
        setupAdmobAdapterCalculatorHelper(10, 10, 10);
        assertThat(admobAdapterCalculator.getAdIndex(10), is(0));
    }

    @Test
    public void testGetAdIndex_position0_itemsBetweenAds0_Result0() {
        setupAdmobAdapterCalculatorHelper(0, 0, 200);
        assertThat(admobAdapterCalculator.getAdIndex(0), is(0));
    }

    @Test
    public void testGetAdIndex_position0_limitAdsIs0_Result0() {
        setupAdmobAdapterCalculatorHelper(10, 0, 0);
        assertThat(admobAdapterCalculator.getAdIndex(0), is(0));
    }

    @Test
    public void testIsAdAvailable_position0_fetchedCntIs3_Success() {
        setupAdmobAdapterCalculatorHelper(10, 0, 10);
        assertThat(admobAdapterCalculator.isAdAvailable(0, 3), is(true));
    }

    @Test
    public void testIsAdAvailable_position22_fetchedCntIs3_Success() {
        setupAdmobAdapterCalculatorHelper(10, 0, 10);
        assertThat(admobAdapterCalculator.isAdAvailable(22, 3), is(true));
    }

    @Test
    public void testIsAdAvailable_position33_fetchedCntIs3_Fail() {
        setupAdmobAdapterCalculatorHelper(10, 0, 10);
        assertThat(admobAdapterCalculator.isAdAvailable(33, 3), is(false));
    }

    @Test
    public void testIsAdAvailable_fetchedCntIs0_Fail() {
        setupAdmobAdapterCalculatorHelper(10, 0, 10);
        assertThat(admobAdapterCalculator.isAdAvailable(0, 0), is(false));
    }

    @Test
    public void testIsAdAvailable_position99_firstIdxIs99_Success() {
        setupAdmobAdapterCalculatorHelper(10, 99, 10);
        assertThat(admobAdapterCalculator.isAdAvailable(99, 10), is(true));
    }

    @Test
    public void testIsAdAvailable_position98_firstIdxIs99_Fail() {
        setupAdmobAdapterCalculatorHelper(10, 99, 10);
        assertThat(admobAdapterCalculator.isAdAvailable(98, 10), is(false));
    }

    @Test
    public void testIsAdAvailable_position100_firstIdxIs99_Success() {
        setupAdmobAdapterCalculatorHelper(10, 99, 10);
        assertThat(admobAdapterCalculator.isAdAvailable(100, 10), is(true));
    }

    @Test
    public void testIsAdAvailable_position10_firstIdxIs10_Success() {
        setupAdmobAdapterCalculatorHelper(10, 10, 10);
        assertThat(admobAdapterCalculator.isAdAvailable(10, 10), is(true));
    }

    @Test
    public void testIsAdAvailable_position0_itemsBetweenAds0_Success() {
        setupAdmobAdapterCalculatorHelper(0, 0, 200);
        assertThat(admobAdapterCalculator.isAdAvailable(0, 200), is(true));
    }

    @Test
    public void testIsAdAvailable_position0_limitAdsIs0_Fail() {
        setupAdmobAdapterCalculatorHelper(10, 0, 0);
        assertThat(admobAdapterCalculator.isAdAvailable(0, 100), is(false));
    }

    @Test
    public void testHasToFetchAd_position0_fetchedCntIs3_Fail() {
        setupAdmobAdapterCalculatorHelper(10, 0, 10);
        assertThat(admobAdapterCalculator.hasToFetchAd(0, 3), is(false));
    }

    @Test
    public void testHasToFetchAd_position22_fetchedCntIs3_Fail() {
        setupAdmobAdapterCalculatorHelper(10, 0, 10);
        assertThat(admobAdapterCalculator.hasToFetchAd(22, 3), is(false));
    }

    @Test
    public void testHasToFetchAd_position33_fetchedCntIs3_Success() {
        setupAdmobAdapterCalculatorHelper(10, 0, 10);
        assertThat(admobAdapterCalculator.hasToFetchAd(33, 3), is(true));
    }

    @Test
    public void testHasToFetchAd_fetchedCntIs0_Success() {
        setupAdmobAdapterCalculatorHelper(10, 0, 10);
        assertThat(admobAdapterCalculator.hasToFetchAd(0, 0), is(true));
    }

    @Test
    public void testHasToFetchAd_position99_firstIdxIs99_Fail() {
        setupAdmobAdapterCalculatorHelper(10, 99, 10);
        assertThat(admobAdapterCalculator.hasToFetchAd(99, 10), is(false));
    }

    @Test
    public void testHasToFetchAd_position98_firstIdxIs99_Fail() {
        setupAdmobAdapterCalculatorHelper(10, 99, 10);
        assertThat(admobAdapterCalculator.hasToFetchAd(98, 10), is(false));
    }

    @Test
    public void testHasToFetchAd_position100_firstIdxIs99_Fail() {
        setupAdmobAdapterCalculatorHelper(10, 99, 10);
        assertThat(admobAdapterCalculator.hasToFetchAd(100, 10), is(false));
    }

    @Test
    public void testHasToFetchAd_position10_firstIdxIs10_Fail() {
        setupAdmobAdapterCalculatorHelper(10, 10, 10);
        assertThat(admobAdapterCalculator.hasToFetchAd(10, 10), is(false));
    }

    @Test
    public void testHasToFetchAd_position0_itemsBetweenAds0_Fail() {
        setupAdmobAdapterCalculatorHelper(0, 0, 200);
        assertThat(admobAdapterCalculator.hasToFetchAd(0, 200), is(false));
    }

    @Test
    public void testHasToFetchAd_position0_limitAdsIs0_Fail() {
        setupAdmobAdapterCalculatorHelper(10, 0, 0);
